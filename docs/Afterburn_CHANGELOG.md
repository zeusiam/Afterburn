...
**⏭ Next:** finish U1 (SO seeder → 8 data assets, pool, input, chase camera, greybox arena, ship spawns), verify the acceptance gate, back up, and **stop for Seni's U1 sign-off** before any U2 gameplay code.
